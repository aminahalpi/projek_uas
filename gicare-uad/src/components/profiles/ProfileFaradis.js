...
const ProfileFaradis = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-center mb-4">drg. Faradis Putra Assegaf</h1>
      <div className="flex flex-col md:flex-row items-center">
        <img
          src={`${process.env.PUBLIC_URL}/ais.jpg`}
          alt="drg. Faradis Putra Assegaf"
